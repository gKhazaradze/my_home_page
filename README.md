...
- **The homepage** — a static two-sided hub (`site/`) that Caddy serves
  directly: the landing page is one door per side, my calendar on the left and
  the projects list on the right. Both sides come from a version-controlled
  registry, no DB.
